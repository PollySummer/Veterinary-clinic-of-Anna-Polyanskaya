	...
	<div class="container-fluid">
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-md-10">
					<h4 class="my-2 mt-4">Дошка адміністратора</h4>

					<div class="col-md-12 my-1">
						<div class="row">
							<div class="col-md-3 bg-success mx-2" style="height: 140px">
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-8">
											<?php 
											...
											<h5 class="text-white ">Адміністраторів</h5>
										</div>
										<div class="col-md-4">
							...
							<div class="col-md-3 bg-info mx-2" style="height: 140px">
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-8">
											...
											<h5 class="text-white ">Лікарів</h5>
										</div>
										<div class="col-md-4">
							...
							<div class="col-md-3 bg-warning mx-2" style="height: 140px">
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-8">
											<?php
							...
							<div class="col-md-3 bg-danger mx-2 my-3" style="height: 140px">
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-8">
											<?php
							...
							<div class="col-md-3 bg-warning mx-2 my-3" style="height: 140px">
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-8">
											<?php 
											...
											<h5 class="text-white ">Запитів на роботу</h5>
										</div>
										<div class="col-md-4">
							...
							<div class="col-md-3 bg-success mx-2 my-3" style="height: 140px">
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-8" >
											<?php
											...
											<h5 class="text-white ">грн</h5>
											<h5 class="text-white ">прибуток</h5>
										</div>
										<div class="col-md-4">
